...
this.x=this.x+this.speed*dt;    
    ...
    // all computers.
/*
Moving player to original place 
*/
if(this.x>550) 
{
	this.x=-100;
...
class Player{
	...
	if(this.y<0)  {
alert('Congratulations! \nYou safely crossed road without colliding with bugs.\n\You Won!');
this.x=200;
this.y =380;}
	}
	render(){
	...
	handleInput(key){
		switch(key){
		case 'left': this.x -= this.speed +50; break;
		case 'right': this.x += this.speed + 50; break;
		case 'up':  	this.y -= this.speed+ 30;  break;
		case 'down':   this.y = this.speed+ 30;  break;
		}
	}
